...
public class GuiIngestObjectDialog extends CGuiComposite
{
	...
	protected void setup() {
		...
		setWidgetName( jbIngest, "jbIngest" );
		setWidgetName( jbImport, "jbImport" );
		setWidgetName( jbEXCEL, "jbEXCEL" );
		...
		setWidgetName( jcbSimulate, "jcbSimulate" );
	...
	private void jbInit()
		...
		jcbSimulate = new JCheckBox( res.getString("ingestsim") );
		...
		jbIngest = new JButton(res.getString("ingestdir") );

		jbImport = new JButton(res.getString("ingestex") );

		jbEXCEL = new JButton(res.getString("ingestexcel") );
		...
		container.add( jcbSimulate, "wrap 10" );
