...
public class GuiImportDialog extends CGuiComposite {
	 ...
	 */
	public GuiImportDialog() {
		super("GuiImportDialog");
	...
	private void jbInit()
		...
		jbOK = new JButton(res.getString("ingestdir"));
		jbCancel = new JButton(res.getString("close"));
		jbShow = new JButton(res.getString("showlog"));
		        
		container.add(new JLabel(res.getString("selectformat")), "wrap 10");
		container.add(new JLabel("(a) FOXML 1.1"), "wrap 5");
		container.add(new JLabel("(b) FOXML 1.0"), "wrap 5");
		container.add(new JLabel("(c) METS with FEDORA Extension 1.1"), "wrap 5");
		container.add(new JLabel("(d) METS with FEDORA Extension 1.0"), "wrap 25");
