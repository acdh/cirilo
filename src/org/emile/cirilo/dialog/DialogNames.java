...
public class DialogNames {
 /**	
	* Description of the Field
	 */
	public final static CServiceName PROPERTYTABLE_DIALOG = new CServiceName("PropertyTableDialog");
	public final static CServiceName NEWOBJECT_DIALOG = new CServiceName("NewObjectDialog");
	public final static CServiceName INGESTOBJECT_DIALOG = new CServiceName("IngestObjectDialog");
	public final static CServiceName EDITOBJECT_DIALOG = new CServiceName("EditObjectDialog");
	public final static CServiceName EDITDC_DIALOG = new CServiceName("EditDCDialog");
	...
	public final static CServiceName SELECTLAYOUT_DIALOG = new CServiceName("SelectLayoutDialog");
	...
	public final static CServiceName TEMPLATER_DIALOG = new CServiceName("TemplaterDialog");
	public final static CServiceName CREATEDATASTREAM_DIALOG = new CServiceName("CreateDatastreamDialog");
	public final static CServiceName INGESTEXCEL_DIALOG = new CServiceName("IngestExcelDialog");
